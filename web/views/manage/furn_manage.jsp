    ...
    <script type="text/javascript">
        $(function () {
            $("a.deleteCss").click(function () {
                // 获取到要删除的家居的名字 -> 拿到a标签的父类(td)的父类(tr)的子类的td的文本名字
                var furnName = $(this).parent().parent().find("td:eq(1)").text();

                // 会弹出一个确认窗口，点击确定返回true，点击取消返回false
                        ...
                        <table>
                            ...
                            <c:forEach items="${requestScope.page.items}" var="furn">
                                <tr>
                                    ...
                                    <td class="product-username"><a href="#">${furn.name}</a></td>
                                    <td class="product-username"><a href="#">${furn.maker}</a></td>
                    ...
                    <c:when test="${requestScope.page.pageNo} > 5">
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <c:set var="end" value="${requestScope.page.pageTotalCount + 2}"/>
                            </c:otherwise>
                        </c:choose>
                    </c:when>
                </c:choose>

                    ...
                    <div class="table-content table-responsive cart-table-content">
                        <table>
                            ...
                            <c:if test="${not empty sessionScope.cart.items}">
                                <!-- {sessionScope.cart.items}是一个HashMap-->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="cart-shiping-update-wrapper">
                                <!--注意这里的属性会自动调用get方法，但是记住名称一定要相同 -->
                                <h4>共${sessionScope.cart.totalCount}件商品 总价 $${sessionScope.cart.cartTotalPrice}</h4>
                                <div class="cart-shiping-update">
                                    <a href="orderServlet?action=saveOrder">生 成 订 单</a>
                                </div>
                                <div class="cart-clear">
                                    <button>继 续 购 物</button>
                                    <a class="clear-cart" href="cartServlet?action=clear">清 空 购 物 车</a>
                                </div>
                            </div>
                        </div>
                    </div>
